...
import BarckgroundImage from '@/public/night-background.webp'
import heroLightImage from '@/public/screenshot-light.png'
import heroNightImage from '@/public/screenshot-night.png'
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span
                                            className="text-foreground text-sm">Introducing Support for AI Models</span>
                                        <span
